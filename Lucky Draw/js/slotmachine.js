...
let items = [
  { value: 1, classname: "item-Foldable-Bags", name: "Foldable Bags", probability: 0.55 },
  { value: 2, classname: "item-Whiteboards", name: "Whiteboards", probability: 0.4 },
  { value: 3, classname: "item-Portable-Fans", name: "Portable Fans", probability: 0.2 },
];
...
// Function to get randomized end numbers
//function getRandomizedEndNumbers(selectedItem) {
//  const randomNum = generateRandomNumber(); // Generate a random number
//  const endNumbers = [selectedItem.value, randomNum, selectedItem.value]; // Create the array
//  return shuffleArray(endNumbers); // Shuffle and return the array
//}
